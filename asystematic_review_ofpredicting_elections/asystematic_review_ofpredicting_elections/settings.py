...
ROOT_URLCONF = 'asystematic_review_ofpredicting_elections.urls'
...
WSGI_APPLICATION = 'asystematic_review_ofpredicting_elections.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'asystematic_review_ofpredicting_elections',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
