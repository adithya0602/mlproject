...
--
-- Host: localhost
-- Generation Time: Nov 05, 2021 at 06:19 AM
...
--
-- Database: `asystematic_review_ofpredicting_elections`
--
CREATE DATABASE IF NOT EXISTS `asystematic_review_ofpredicting_elections` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `asystematic_review_ofpredicting_elections`;
...
('afyu4bo0azwegjh35efshq7ks1hwiudg', 'eyJ1c2VyaWQiOjI0fQ:1miGFc:YrTEXa5Uczmps1GsvZGwPHLjaOI5R1CNR7-360vqdN8', '2021-11-17 13:24:24.362729'),
...
('p74g49zlglgdaykup7h1i7zzem561p1c', 'eyJ1c2VyaWQiOjExfQ:1miElw:CquFp6--7-yRgZUbH7PNDvnwqAm-3Pt4NXcOU448En8', '2021-11-17 11:49:40.575903'),
...
--
-- Table structure for table `remote_user_election_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_election_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tweeter` varchar(300) NOT NULL,
  `total_tweet_Time` varchar(300) NOT NULL,
  `tweet` varchar(30000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `remote_user_election_prediction_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_election_prediction_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tweeter` varchar(300) NOT NULL,
  `total_tweet_Time` varchar(300) NOT NULL,
  `tweet` varchar(30000) NOT NULL,
